...
public class ClientFile {
    ...
    private String clientFilePath = "F:\\projects\\BankSystem\\src\\ClientFile.txt";
    ...
    /**
     * This method adds account to List of Account in ClientFile
    ...
    public void addAccountToClientFile(int clientID, int accountID) throws IOException {
        ...
        while (fileReader.ready()) {
            ...
            try {
                ...
                System.out.println("NumberFormatException in ClientFile");
                continue;
            }
    ...
    /**
     * When client deletes his account this method removes accountId from ClientFile
     * @param clientID - id of client which account we add
     * @param accountID - id of account that we add
     */
